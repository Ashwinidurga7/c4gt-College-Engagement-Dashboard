...
export const campusPlacementData = {
  ...
  topHiringPartners: [
    { name: 'Amazon Web Services (AWS)', category: 'Tier-1 Cloud', packages: '₹18.0 - ₹31.5 LPA', hiredCount: 28, logo: 'globe' },
    { name: 'Tata Consultancy Services (TCS)', category: 'Enterprise IT & AI', packages: '₹7.2 - ₹14.0 LPA', hiredCount: 164, logo: 'building' },
    { name: 'Infosys Springboard', category: 'Global Systems', packages: '₹6.5 - ₹12.0 LPA', hiredCount: 142, logo: 'laptop' },
    { name: 'ServiceNow', category: 'Cloud Platform', packages: '₹14.0 - ₹24.0 LPA', hiredCount: 18, logo: 'bolt' },
    { name: 'Tech Mahindra IoT Lab', category: 'Smart Devices & Telecom', packages: '₹5.5 - ₹10.5 LPA', hiredCount: 96, logo: 'phone' },
    { name: 'Wipro Technologies', category: 'Software & Security', packages: '₹6.5 - ₹11.0 LPA', hiredCount: 110, logo: 'globe' },
    { name: 'AP Innovation Society (APIS)', category: 'Govt. Startup Fellowship', packages: '₹4.8 - ₹8.0 LPA', hiredCount: 36, logo: 'institution' },
    { name: 'Accenture Technology', category: 'Consulting & Analytics', packages: '₹5.8 - ₹10.0 LPA', hiredCount: 88, logo: 'trending-up' },
  ],
